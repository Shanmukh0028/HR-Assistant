...
CREATE TABLE `query_audit` (
  ...
  `status_change` enum('OPEN','CLOSED','ASSIGNED','REASSIGNED') NOT NULL,
  `changed_by` bigint NOT NULL,
  `created_at` timestamp NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`),
  KEY `query_id` (`query_id`),
  KEY `changed_by` (`changed_by`),
  CONSTRAINT `query_audit_ibfk_1` FOREIGN KEY (`query_id`) REFERENCES `queries` (`id`),
  CONSTRAINT `query_audit_ibfk_2` FOREIGN KEY (`changed_by`) REFERENCES `users` (`id`)
